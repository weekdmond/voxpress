...
export const articleDetails: Record<string, ArticleDetail> = {
  a_001: {
    ...
    raw_text:
      '大家好,欢迎回到老钱说AI。今天我们不讲产品,讲硬件。\nM5 Max 最大的变化不在于单核多核,而在于统一内存的调度。',
    corrected_text:
      '大家好，欢迎回到老钱说 AI。今天我们不讲产品，讲硬件。\nM5 Max 最大的变化不在于单核多核，而在于统一内存的调度。',
    correction_status: 'ok',
    corrections: [],
    whisper_model: 'qwen3-asr-flash-filetrans',
    whisper_language: 'zh',
    corrector_model: 'qwen-turbo',
    initial_prompt_used: '为什么 Qwen2.5-72B 在 M5 Max 上终于跑得动了。老钱说AI',
    segments: [
  ...
  a_002: {
    ...
    raw_text:
      '今天是周五,产品经理的一天应该这样开始:先看昨天有没有没回的设计评审。',
    corrected_text:
      '今天是周五，产品经理的一天应该这样开始：先看昨天有没有没回的设计评审。',
    correction_status: 'ok',
    corrections: [],
    ...
    whisper_language: 'zh',
    corrector_model: 'qwen-turbo',
    initial_prompt_used: '一个产品经理的周五:把 Figma 交付链路磨薄。武侯科技',
    segments: [
...
for (const a of articles) {
  if (!articleDetails[a.id]) {
    articleDetails[a.id] = {
      ...
      raw_text: '这是一段示例逐字稿。\n真实内容会由 whisper 生成。',
      corrected_text: '这是一段示例逐字稿。\n真实内容会由 whisper 生成。',
      correction_status: 'skipped',
      corrections: [],
      whisper_model: 'qwen3-asr-flash-filetrans',
      whisper_language: 'zh',
      corrector_model: null,
      initial_prompt_used: null,
      segments: [
